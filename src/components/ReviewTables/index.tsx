...
const ReviewTables = ({ table_head_columns, table_rows, big_table }: any) => {
    return (
        <section className="review-tables">
            <div className="container">
                <div className="review-tables__inner u-d-flex">
                    <div className="review-tables__left">
                        <BigTable items={big_table} />
                    </div>
                    <div className="review-tables__right">
